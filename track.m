...
%   tipsubfundo: tioi de subtracao de fundo 0 -> subtracao basica  1 ->
...
function [t,posicao,velocidade,parado,dormindo,tempoareas,distperc,comportamento] = track(mostraresnatela,quadroini,quadrofim,fotos,video,pixelcm,nanimais,procframe...
    ,corte,areas,areasexc,criavideores,viddiff,thresh,filt,handles,fundodinamico,tipfilt,tipsubfundo,velmin,tempmin,tempminparado,subcor,cameralenta,trackmouse,pinicial,liveTracking,trackindividuals)
...
%numero de QAUDROS por SEGUNDO do video
fps = video.FrameRate;
